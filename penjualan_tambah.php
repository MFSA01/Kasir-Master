<?php
    if(isset($_POST['id_pelanggan'])) {
        ...
        $query = mysqli_query($koneksi, "INSERT INTO penjualan(tgl_penjualan,id_pelanggan) values ('$tanggal','$id_pelanggan')");
                        ...
                        <form method="post">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td width="1">:</td>
                                    <td><input class="form-control" type="date" name="tgl_penjualan"></td>
                                </tr>
                                <tr>
